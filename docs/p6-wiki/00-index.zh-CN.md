...
P6 的任务不是立刻堆新功能，而是把外部智能体项目拆清楚：它们各自有什么功能、有什么工具、前后端或入口和 runtime 是怎么贯穿的、哪些设计能进入 NanoBot.net，哪些只能看不能碰。
...
NanoBot.net 继续作为 GroundPA / Nong agent runtime 主线。外部项目不作为替代主仓库，而是作为教材：
...
- [ADR-001：NanoBot.net 保持主线](04-decisions/adr-001-nanobot-stays-mainline.zh-CN.md)
