...
把 NanoBot.net 从“能聊天、能展示 WebUI、能跑基础工具”的状态推进到“可观测、可恢复、可扩展”的 agent runtime。
...
这时再进入 P8：GitCode/CodingPlan、plugin marketplace、GroundPA/Nong bootstrap 的实现会更稳，因为 runtime、事件、session、工具边界已经先固定住。
