...
**一个基于 .NET 10 的个人 AI Agent 运行时，支持本地自动化、聊天网关、工具、记忆、MCP 和多 Provider LLM 路由。**
...
NanoBot.net 是对 [HKUDS/nanobot](https://github.com/HKUDS/nanobot) 轻量个人 Agent 思路的 .NET 10 重建版。它保留 local-first 模式：本地配置、本地工作区、本地记忆、直接工具执行，不强依赖云端控制面。
...
| Tools | 完整 | 文件、shell、web、天气、CSV 股票报价、GitHub、摘要、记忆 |
...
MIT。受 [HKUDS/nanobot](https://github.com/HKUDS/nanobot) 启发，使用 .NET 10 重建。
